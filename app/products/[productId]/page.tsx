        ...
        return (
            <div className="w-80 absolute mt-24 right-6 rounded-3xl bg-[hsl(var(--surface))] space-y-7 flex-col align-center p-6 drop-shadow-lg">
                ...
                <div className="flex flex-row justify-between">
                    <div className="flex flex-row justify-self-start text-sm text-[hsl(var(--text-primary))]">Subtotal: &nbsp;<div className="font-semibold"> CA${subtotal}</div></div>
                    <div className="flex flex-row justify-self-end text-sm text-[hsl(var(--text-primary))]"><div className="font-semibold">{numItems}</div>&nbsp;item</div>
                </div>
                ...
                <div className="flex flex-col space-y-4">    
                    <button className="w-100 h-100 text-center bg-[hsl(var(--btn-primary))] text-[hsl(var(--btn-primary-text))] p-3 text-m rounded-2xl hover:bg-[hsl(var(--btn-primary-hover))]">View and Edit Cart</button>
                    <button className="w-100 h-100 text-center bg-[hsl(var(--btn-primary))] text-[hsl(var(--btn-primary-text))] p-3 text-m rounded-2xl hover:bg-[hsl(var(--btn-primary-hover))]">Secure Checkout</button>
                </div>
            </div>
        );
}
        ...
        <div className="flex flex-col min-h-screen">
            <main className="flex-grow bg-surface py-16 px-4">
                <div className="max-w-6xl mx-auto bg-background p-8 rounded-lg shadow-md">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 text-text-primary">Stock Information</h2>
                    <p className="text-text-secondary">Currently in stock: {bike.amount_stocked}</p>
                </div>
            </main>
        </div>
    );
