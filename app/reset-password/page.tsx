    ...
    <div className="h-screen w-full flex items-center justify-center">
      ...
      >
        ...
        <input
          ...
          required
          type="password"
          className="w-full p-2 pr-9 mb-4 border border-[hsl(var(--border))] rounded bg-[hsl(var(--surface))] text-[hsl(var(--text-primary))] focus:ring-2 focus:ring-[hsl(var(--border-focus))] focus:border-[hsl(var(--border-focus))]"
        />
